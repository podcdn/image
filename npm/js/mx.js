...
function testAdd()
{
	for(i = 0; i < 35; i++)
	{
		$(".L").append('<div class="item"><a href="#{播放页面}" style="background: url(&quot;/img/('+i+').jpg&quot;);padding-bottom: 75%;"></a> <a href="#{播放页面}" class="else" style="background: rgba(221, 179, 179, 0.3);"><s>{标签}</s> <h3>{标题}</h3> <p class="here"><i class="icon-comment">142</i> <i class="icon-images">15</i> <i class="icon-key">2</i> <!----></p></a></div>');
	}
